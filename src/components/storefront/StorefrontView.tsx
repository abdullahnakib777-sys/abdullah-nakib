...
export const StorefrontView: React.FC<{
  ...
  const cosmicStories = [
    {
      id: 'zero-inv',
      title: '০৳ ইনভেস্টমেন্ট',
      subtitle: 'Free Wholesale',
      icon: Zap,
    ...
    {
      id: 'instant-payout',
      title: 'বিকাশ/নগদ পে-আউট',
      subtitle: 'Instant Profit',
      icon: Wallet,
    ...
    <div className="space-y-8 sm:space-y-12 pb-24 sm:pb-12" id="storefront-view">
        ...
        {cosmicStories.map((story) => {
          ...
          return (
            <button
              ...
              className="flex-shrink-0 flex flex-col items-center gap-1.5 group text-center focus:outline-none"
            >
              ...
              <span className="text-[10px] font-black text-slate-200 tracking-tight leading-none max-w-[65px] truncate">
                {story.title}
              </span>
            </button>
          );
      ...
      <div className="relative rounded-3xl p-6 sm:p-12 shadow-[0_0_50px_rgba(99,102,241,0.25)] overflow-hidden border border-purple-500/30 bg-gradient-to-r from-[#131127]/80 via-[#1f1938]/80 to-[#121829]/80 backdrop-blur-xl">
        ...
        <div className="relative z-10 max-w-2xl space-y-4 sm:space-y-6">
          <div className="inline-flex items-center gap-2 px-3 py-1 sm:px-3.5 sm:py-1.5 rounded-full bg-purple-900/60 text-cyan-300 text-xs font-bold border border-cyan-400/30 shadow-[0_0_15px_rgba(6,182,212,0.3)]">
            ...
            <span className="text-[11px] sm:text-xs">✨ Bangladesh's #1 Galaxy Reselling Platform</span>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-2.5 sm:gap-3 pt-2">
            {!isResellerOrAdmin ? (
              <button
                ...
                className="w-full sm:w-auto px-6 py-3.5 rounded-2xl bg-gradient-to-r from-amber-400 via-orange-400 to-amber-500 hover:from-amber-300 hover:to-orange-400 text-slate-950 font-black text-xs sm:text-sm transition shadow-[0_0_25px_rgba(251,191,36,0.45)] flex items-center justify-center gap-2 group"
              >
                <Sparkles className="w-4 h-4 text-slate-950" />
                <span>Become a Reseller (৫০০৳)</span>
                <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
              </button>
            ) : (
              <button
                onClick={() => onNavigateTab('reseller_hub')}
                className="w-full sm:w-auto px-6 py-3.5 rounded-2xl bg-gradient-to-r from-cyan-400 via-teal-400 to-emerald-400 hover:from-cyan-300 hover:to-emerald-300 text-slate-950 font-black text-xs sm:text-sm transition shadow-[0_0_25px_rgba(6,182,212,0.45)] flex items-center justify-center gap-2 group"
              >
            ...
            <button
              ...
              className="w-full sm:w-auto px-5 py-3.5 rounded-2xl bg-purple-950/50 hover:bg-purple-900/60 text-cyan-200 font-bold text-xs sm:text-sm backdrop-blur-md transition border border-purple-500/30 hover:border-cyan-400/50 shadow-xs flex items-center justify-center gap-2"
            >
      ...
      <div className="galaxy-glass-card-static p-5 sm:p-8 rounded-3xl border border-purple-500/30 space-y-6">
        <div className="text-center max-w-xl mx-auto space-y-1">
          ...
          <h2 className="text-xl sm:text-2xl font-black text-white">How MeherMart Reseller Works</h2>
        </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
          <div className="galaxy-glass p-3.5 sm:p-5 rounded-2xl border border-cyan-500/30 hover:border-cyan-400/60 space-y-1.5 sm:space-y-2 transition-all hover:-translate-y-1 animate-float-gentle">
            ...
            <h3 className="font-bold text-xs sm:text-sm text-white">Select Product</h3>
            <p className="text-[11px] sm:text-xs text-slate-300 leading-tight">
              Browse 500+ verified factory items at wholesale pricing.
            </p>
          </div>
          ...
          <div className="galaxy-glass p-3.5 sm:p-5 rounded-2xl border border-indigo-500/30 hover:border-indigo-400/60 space-y-1.5 sm:space-y-2 transition-all hover:-translate-y-1 animate-float-gentle-delayed">
            ...
            <h3 className="font-bold text-xs sm:text-sm text-white">Share with AI</h3>
            <p className="text-[11px] sm:text-xs text-slate-300 leading-tight">
              Post to Facebook Marketplace with 1-click Bangla copy.
            </p>
          </div>
          ...
          <div className="galaxy-glass p-3.5 sm:p-5 rounded-2xl border border-purple-500/30 hover:border-purple-400/60 space-y-1.5 sm:space-y-2 transition-all hover:-translate-y-1 animate-float-gentle-slow">
            ...
            <h3 className="font-bold text-xs sm:text-sm text-white">We Ship COD</h3>
            <p className="text-[11px] sm:text-xs text-slate-300 leading-tight">
              Steadfast/Pathao delivers to customer door.
            </p>
          </div>
          ...
          <div className="galaxy-glass p-3.5 sm:p-5 rounded-2xl border border-amber-500/30 hover:border-amber-400/60 space-y-1.5 sm:space-y-2 transition-all hover:-translate-y-1 animate-float-gentle">
            ...
            <h3 className="font-bold text-xs sm:text-sm text-white">Collect Profit</h3>
            <p className="text-[11px] sm:text-xs text-slate-300 leading-tight">
              Profit sent to your bKash / Nagad wallet.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-4 sm:space-y-6">
        <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-3 sm:gap-4">
          ...
          <div className="flex flex-wrap items-center gap-2 w-full md:w-auto">
            ...
            <div className="relative flex-1 sm:w-64 md:w-72">
              ...
              {searchQuery && (
                <button
                  ...
                  className="absolute right-2.5 top-2.5 text-slate-400 hover:text-white p-0.5 rounded-full hover:bg-purple-900/60 transition"
                  title="Clear search"
                >
            ...
            <div className="relative">
              ...
              >
                <option value="trending" className="bg-[#0f0e26] text-slate-200">🔥 Trending</option>
                <option value="newest" className="bg-[#0f0e26] text-slate-200">✨ Newest First</option>
                <option value="price_low" className="bg-[#0f0e26] text-slate-200">💰 Price: Low to High</option>
                <option value="price_high" className="bg-[#0f0e26] text-slate-200">💎 Price: High to Low</option>
              </select>
        ...
        <div className="flex gap-2 overflow-x-auto pb-1 no-scrollbar text-xs">
          <button
            ...
            className={`px-3.5 py-1.5 sm:px-4 sm:py-2 rounded-full font-bold transition shrink-0 ${
        ...
        {filtered.length === 0 ? (
          <EmptyState
            ...
            description={
              searchQuery
                ? `No cosmic products matched "${searchQuery}". Try searching with another keyword or resetting filters.`
                ...
                >
                  <div>
                    ...
                    <div className="p-3 sm:p-4 space-y-1.5 sm:space-y-2">
                      ...
                      <p className="text-[11px] sm:text-xs text-slate-300 font-medium line-clamp-1">{product.nameBn}</p>
                      ...
                      {isResellerOrAdmin ? (
                        <div className="p-1.5 sm:p-2 bg-emerald-950/40 rounded-xl border border-emerald-500/30 text-[10px] sm:text-xs flex justify-between font-bold">
                          ...
                          <span className="text-emerald-400">৳{profit} লাভ</span>
                        </div>
                      ) : (
                        <p className="text-[10px] sm:text-[11px] text-teal-300 font-semibold flex items-center gap-1 truncate">
                          <Truck className="w-3 h-3 text-cyan-400 shrink-0" /> COD Available
                        </p>
                      )}
                    </div>
                  </div>
                    ...
                    {isResellerOrAdmin ? (
                      <div className="grid grid-cols-2 gap-1.5 sm:gap-2">
                        <button
                          ...
                          className="py-2 sm:py-2.5 px-2 sm:px-3 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-400 hover:to-teal-400 text-slate-950 font-black text-[10px] sm:text-xs shadow-[0_0_12px_rgba(16,185,129,0.3)] transition flex items-center justify-center gap-1"
                        >
                        ...
                        <button
                          ...
                          className="py-2 sm:py-2.5 px-2 sm:px-3 rounded-xl bg-purple-900/50 hover:bg-purple-800/60 text-cyan-300 border border-purple-500/30 font-bold text-[10px] sm:text-xs transition flex items-center justify-center gap-1"
                        >
                      ...
                      <button
                        ...
                        className="w-full py-2 sm:py-2.5 px-2 sm:px-4 rounded-xl bg-gradient-to-r from-cyan-500 via-indigo-600 to-purple-600 hover:from-cyan-400 hover:to-purple-500 text-white font-bold text-[10px] sm:text-xs shadow-[0_0_15px_rgba(6,182,212,0.4)] transition flex items-center justify-center gap-1"
                      >
                        <ShoppingBag className="w-3 h-3 sm:w-3.5 sm:h-3.5" />
