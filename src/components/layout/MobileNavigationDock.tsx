    ...
    <div className="md:hidden fixed bottom-3 inset-x-0 z-50 px-3 pointer-events-none">
      ...
      >
        ...
        <button
          ...
          className={`flex-1 flex flex-col items-center justify-center py-2 px-1 rounded-2xl transition-all duration-300 relative group ${
        ...
        >
          ...
          />
          <span className="text-[10px] font-bold mt-0.5 tracking-tight">Store</span>
          {currentView === 'storefront' && (
        ...
        {isReseller ? (
          <button
            ...
            className={`flex-1 flex flex-col items-center justify-center py-2 px-1 rounded-2xl transition-all duration-300 relative group ${
              isResellerHubView
                ? isResellerVerified
                  ? 'bg-gradient-to-b from-emerald-500/30 to-teal-500/20 text-emerald-300 shadow-[0_0_15px_rgba(16,185,129,0.35)] border border-emerald-400/40'
          ...
          >
            ...
            />
            <span className="text-[10px] font-bold mt-0.5 tracking-tight">Hub</span>
            {isResellerHubView && (
          ...
          <button
            ...
            className="flex-1 flex flex-col items-center justify-center py-2 px-1 rounded-2xl text-amber-300 hover:text-amber-200 transition-all duration-300 group"
          >
            ...
            <span className="text-[10px] font-bold mt-0.5 tracking-tight">Join (৳500)</span>
          </button>
        )}
        ...
        <button
          ...
          className="relative -top-3 px-3.5 py-2.5 rounded-2xl bg-gradient-to-tr from-purple-600 via-indigo-600 to-cyan-400 text-white shadow-[0_0_25px_rgba(168,85,247,0.6),0_0_12px_rgba(6,182,212,0.5)] border border-cyan-300/40 transition-transform active:scale-95 group"
        ...
        <button
          ...
          className="flex-1 flex flex-col items-center justify-center py-2 px-1 rounded-2xl text-slate-400 hover:text-cyan-300 transition-all duration-300 relative group"
        >
        ...
        >
          ...
          <span className="text-[10px] font-bold mt-0.5 tracking-tight">Cart</span>
        </button>
        ...
        <button
          ...
          className="flex-1 flex flex-col items-center justify-center py-2 px-1 rounded-2xl text-slate-400 hover:text-slate-200 transition-all duration-300 relative group"
        >
          {user ? (
