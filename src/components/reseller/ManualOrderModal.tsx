          ...
          <div className="p-4 bg-slate-50 rounded-2xl border border-slate-200 space-y-4">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 text-sm bg-white text-slate-900 font-medium border border-slate-300 rounded-xl focus:ring-2 focus:ring-emerald-500"
              >
                {products.map((p) => (
            ...
            <div className="grid sm:grid-cols-2 gap-3">
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 text-xs bg-white text-slate-900 font-medium border border-slate-300 rounded-xl"
                >
